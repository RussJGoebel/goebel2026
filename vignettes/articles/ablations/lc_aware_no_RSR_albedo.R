# =============================================================================
# Experiment: LC-aware W (alpha tuned), no RSR -- semi-synthetic albedo
# =============================================================================
...
# Semi-synthetic albedo: aggregate true grid to sounding level, add noise
...
make_Q_spatial <- function(alpha) {
  IminusW <- Matrix::Diagonal(p) - make_W_lc(alpha, water_grid_p, W_std)
...
# CV
# -----------------------------------------------------------------------------
cat("Tuning LC-aware W (alpha in [0,1]), no RSR ...\n")
...
usethis::use_data(results_lc_norsr_albedo, overwrite = TRUE)
