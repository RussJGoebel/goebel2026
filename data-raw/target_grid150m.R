...
resolution_of_grid <- 150 # grid cell size (in meters)
buffer <- 25 * resolution_of_grid*330/150 # buffer to add to edges of grid
...
target_grid_150m <- target_grid

### Save ######################################################################
usethis::use_data(target_grid_150m, overwrite = TRUE)
