...
# ------------------------------------------------------------------------------
# 6. Recompute metrics on covered pixels only
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# 8. Save results to package
# ------------------------------------------------------------------------------

message("\nSaving contingency results to goebel2026 package...")

results_contingency_uu <- list(
  label          = "gen=uniform, fit=uniform",
  gen_A          = "uniform",
  fit_A          = "uniform",
  tau_gen        = NA_real_,
  tau_fit        = NA_real_,
  phi            = r_unif_unif$tuned$phi,
  rmse           = r_unif_unif$rmse,
  r2             = r_unif_unif$r2,
  posterior_mean = r_unif_unif$fit$posterior_mean,
  covered        = covered
)

results_contingency_ug <- list(
  label          = "gen=uniform, fit=g-weighted",
  gen_A          = "uniform",
  fit_A          = "g_weighted",
  tau_gen        = NA_real_,
  tau_fit        = 1/3,
  phi            = r_unif_g$tuned$phi,
  rmse           = r_unif_g$rmse,
  r2             = r_unif_g$r2,
  posterior_mean = r_unif_g$fit$posterior_mean,
  covered        = covered
)

results_contingency_gu <- list(
  label          = "gen=g-weighted, fit=uniform",
  gen_A          = "g_weighted",
  fit_A          = "uniform",
  tau_gen        = 1/3,
  tau_fit        = NA_real_,
  phi            = r_g_unif$tuned$phi,
  rmse           = r_g_unif$rmse,
  r2             = r_g_unif$r2,
  posterior_mean = r_g_unif$fit$posterior_mean,
  covered        = covered
)

results_contingency_gg <- list(
  label          = "gen=g-weighted, fit=g-weighted",
  gen_A          = "g_weighted",
  fit_A          = "g_weighted",
  tau_gen        = 1/3,
  tau_fit        = 1/3,
  ...
  rmse           = r_g_g$rmse,
  r2             = r_g_g$r2,
  posterior_mean = r_g_g$fit$posterior_mean,
  covered        = covered
)
...
message("Saved: results_contingency_uu/ug/gu/gg")
...
make_map <- function(result, row_label, col_label) {
  ...
  subtitle <- sprintf("RMSE=%.4f  R2=%.3f", result$rmse, result$r2)
